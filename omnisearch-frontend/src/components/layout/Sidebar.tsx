...
const navigation = [
  ...
  { name: 'Inspection Logs', href: '/logs', icon: LogsIcon },
  { name: 'Model Status', href: '/model', icon: ModelIcon },
      ...
      >
        <div className="flex items-center justify-center h-16 px-4 bg-gray-950">
          <div className="flex items-center">
            ...
            <span className="ml-2 text-xl font-bold text-white">Vision System</span>
          </div>
        </div>
